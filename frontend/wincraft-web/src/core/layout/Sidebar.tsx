...
const navItems = [
  ...
  { label: 'CRM متكامل',     path: '/crm-hub',      icon: '🧑‍🤝‍🧑', permission: 'crm.view' },
  { label: 'عروض الأسعار',   path: '/quotations',   icon: '📄', permission: 'quote.view' },
  { label: 'عروض متكاملة',   path: '/quotation-hub', icon: '💼', permission: 'quote.view' },
  ...
  { label: 'مركز المشاريع',  path: '/project-hub',  icon: '📋', permission: 'project.view' },
  { label: 'أوامر التصنيع',  path: '/work-orders',  icon: '⚙️', permission: 'production.view' },
  { label: 'أرضية المصنع',   path: '/shop-floor',   icon: '🔩', permission: 'production.view' },
